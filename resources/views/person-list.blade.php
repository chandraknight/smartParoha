...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/src/plugins/datatables/media/css/jquery.dataTables.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/src/plugins/datatables/media/css/dataTables.bootstrap4.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/src/plugins/datatables/media/css/responsive.dataTables.css')}}">
</head>
<body>
