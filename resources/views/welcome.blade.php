                ...
                <div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
                    ...
                    <div class="notification-list mx-h-450 customscroll">
                        <ul>
                            <li>
                                <a href="#">
                                    <img src="{{URL::asset('assets/vendors/images/img.jpg')}}" alt="">
...
<script src="{{URL::asset('assets/src/plugins/highcharts-6.0.7/code/highcharts.js')}}"></script>
<script src="{{URL::asset('assets/src/plugins/highcharts-6.0.7/code/highcharts-more.js')}}"></script>
